...
Ipv6= requests.get('https://api.ipify.org').text.strip()
Ipv4= requests.get('https://api.ipify.org').text.strip()
Ipv6= requests.get('https://api.ipify.org').text.strip()
Ipv4= requests.get('https://api.ipify.org').text.strip()
Ipv6= requests.get('https://api.ipify.org').text.strip()
...
[0mCurrent IPv4: [38;2;255;0;255m{Ipv4}[0m
[0mCurrent IPv4: [38;2;255;0;255m{Ipv4}[0m
[0mCurrent IPv6: [38;2;255;0;255m{Ipv6}[0m
[0mCurrent IPv4: [38;2;255;0;255m{Ipv4}[0m
[0mCurrent IPv6: [38;2;255;0;255m{Ipv6}[0m
[0mCurrent IPv4: [38;2;255;0;255m{Ipv4}[0m
[0mCurrent IPv4: [38;2;255;0;255m{Ipv4}[0m
...
def menu():
    sys.stdout.write(f"\x1b]2;Ipan DDoS | Plant: [25$] | Online: [{online}] | Methods: [23] | Expiry: [30] | Username: [{uname}]\x07")
    os.system('cls' if os.name == 'nt' else 'clear')
    si()
    print(f"""
